...
import com.sigep.gbc.service.FournisseursService;

import lombok.RequiredArgsConstructor;

@RestController
@RequestMapping("/gbc/fournisseurs")
@RequiredArgsConstructor
@CrossOrigin
public class FournisseursController {
	private final FournisseursService service;
	...
	public ResponseEntity<List<FournisseursResponseDto>> getAll() {
		List<FournisseursResponseDto> list = service.getAll();
