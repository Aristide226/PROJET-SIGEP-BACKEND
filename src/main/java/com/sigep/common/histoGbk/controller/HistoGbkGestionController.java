...
import com.sigep.common.histoGbk.service.HistoGbkGestionService;

import lombok.RequiredArgsConstructor;

@RestController
@RequestMapping("/histoGbk/gestion")
@RequiredArgsConstructor
@CrossOrigin
public class HistoGbkGestionController {
	private final HistoGbkGestionService service;
